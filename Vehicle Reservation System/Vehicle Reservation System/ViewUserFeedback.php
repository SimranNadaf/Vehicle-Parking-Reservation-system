...
<br><br><br>
     ...
     <h3 class="text-center" >View User Feedback</h3>
   </div>
  </div>
...
<div class="container-fluid justify-content-center table-responsive">
 ...
 <table class="table" style=" width:80%; margin:0 auto; margin-top:30px; margin-left:110px;">
  <thead>
    <tr class="bg-success">
      <th scope="col" style="width:10%; color:white">UserName</th>
      <th scope="col" style="width:10%; color:white">Email</th>
      <th scope="col" style="width:10%; color:white">Message</th>
      <th scope="col" style="width:10%; color:white">FeedBack Type</th>    
    </tr>
  </thead>
  <tbody>
  <?php 
