...
<head>
  ...
  <a class="nav-link" style="color:white;" href="contact.php">Contact Us<span class="sr-only">(current)</span></a>
    ...
    <br><br><br>
     ...
     <h3 class="text-center" >View Parking Slots</h3>
   </div>
  </div>
 ...
 <table class="table" style=" width:80%; margin:0 auto; margin-top:30px; margin-left:110px;">
  <thead>
    <tr class="bg-success">
      ...
      <th scope="col" style="width:10%; color:white">Type</th>    
      <th scope="col" style="width:10%; color:white">Action</th>    
...
?>
  <tr>
     ...
     <td><?php echo "Parking Slot ".$row['Parking Zone'];?></td>
      <td><?php echo $row['Type'];?></td> 
  <td><a href='ParkingSlotDelete.php?id=<?php echo $row['Id']; ?>'>
<input type='submit' class="btn btn-danger" name="delete"  value='Delete' id='delete'></a></td>
