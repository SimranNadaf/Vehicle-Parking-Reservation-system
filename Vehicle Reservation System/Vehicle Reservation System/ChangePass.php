...
<form method="post" action="ChangePassProcess.php?id=<?php echo $_GET['id']; ?>">
<label class="ssr-only" for="pwd">Old Password</label>
 
     <br>
   
    <input type="text" class="form-control" name="pwd" id="pwd" placeholder="Enter Old Password" required>

    <br>

  <label class="ssr-only" for="pwd1">New Password</label>
 
    <br>
  
   <input type="text" class="form-control" name="pwd1" id="pwd1" placeholder="Enter New Password" required>
